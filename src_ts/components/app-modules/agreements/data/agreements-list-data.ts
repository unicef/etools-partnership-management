  ...
  query(
    ...
    window.EtoolsPmpApp.DexieDb.transaction(
      ...
      function () {
        ...
        queryResult = queryResult.filter(function (
          ...
          if (
            !isEmptyObject(agreementTypes) &&
            agreementTypes.indexOf(agreement.agreement_type!) === -1
          ) {
            return false;
          }

          if (
            !isEmptyObject(agreementStatuses) &&
            agreementStatuses.indexOf(agreement.status!) === -1
          ) {
            return false;
          }
          ...
          if (
            ...
            startDate.length &&
            (!agreement.start ||
              !moment.utc(agreement.start).isAfter(moment.utc(startDate)))
          ) {
            return false;
          }
          ...
          if (
            ...
            endDate.length &&
            (!agreement.end ||
              !moment.utc(agreement.end).isBefore(moment.utc(endDate)))
          ) {
            return false;
          }
          ...
          if (
            ...
            cpStructures.indexOf(agreement.country_programme!) === -1
          ) {
            return false;
          }
          ...
          if (
            searchString &&
            searchString.length &&
            agreement.agreement_number!.toLowerCase().indexOf(searchString) <
              0 &&
