 ...
 */
function FrNumbersConsistencyMixin<T extends Constructor<LitElement>>(superClass: T) {
  class FrNumbersConsistencyClass extends EtoolsCurrency(superClass as Constructor<LitElement>) {
